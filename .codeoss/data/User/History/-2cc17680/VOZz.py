...
@app.post("/productskafka/", response_model=Product)
async def create_product_kafka(product: Product, session: Annotated[Session, Depends(get_session)], producer: Annotated[AIOKafkaProducer, Depends(get_kafka_producer)])->Product:
